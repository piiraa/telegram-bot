  ...
  class InlineQueryResultCachedGif
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultCachedGif` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultCachedGif`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gif_file_id')
        self.gif_file_id = attributes[:'gif_file_id']
      else
        self.gif_file_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @gif_file_id.nil?
        invalid_properties.push('invalid value for "gif_file_id", gif_file_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @gif_file_id.nil?
      true
    end
    ...
    def hash
      [type, id, gif_file_id, title, caption, parse_mode, caption_entities, reply_markup, input_message_content].hash
    end
