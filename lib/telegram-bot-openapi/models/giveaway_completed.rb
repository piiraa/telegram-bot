...
module TelegramBotOpenapi
  ...
  class GiveawayCompleted
    ...
    attr_accessor :giveaway_message
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::GiveawayCompleted` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::GiveawayCompleted`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'giveaway_message')
        self.giveaway_message = attributes[:'giveaway_message']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          giveaway_message == o.giveaway_message
    end
    ...
    def hash
      [winner_count, unclaimed_prize_count, giveaway_message].hash
    end
