...
module TelegramBotOpenapi
  ...
  class InputSticker
    ...
    def self.openapi_types
      {
        :'sticker' => :'Hash<String, SendPhotoPhotoParameterValue>',
        :'format' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InputSticker` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InputSticker`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'sticker')
        if (value = attributes[:'sticker']).is_a?(Hash)
          self.sticker = value
        end
      else
        self.sticker = nil
      ...
      if attributes.key?(:'emoji_list')
        if (value = attributes[:'emoji_list']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @sticker.nil?
        invalid_properties.push('invalid value for "sticker", sticker cannot be nil.')
      end
      ...
      if @emoji_list.nil?
        invalid_properties.push('invalid value for "emoji_list", emoji_list cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sticker.nil?
      return false if @format.nil?
      return false if @emoji_list.nil?
      true
    end
    ...
    def hash
      [sticker, format, emoji_list, mask_position, keywords].hash
    end
