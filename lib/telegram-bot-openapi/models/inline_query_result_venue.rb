...
module TelegramBotOpenapi
  ...
  class InlineQueryResultVenue
    ...
    attr_accessor :foursquare_type

    # Optional. Google Places identifier of the venue
    attr_accessor :google_place_id

    # Optional. Google Places type of the venue. (See supported types.)
    attr_accessor :google_place_type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultVenue` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultVenue`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'foursquare_id')
        self.foursquare_id = attributes[:'foursquare_id']
      end

      if attributes.key?(:'foursquare_type')
        self.foursquare_type = attributes[:'foursquare_type']
      end
      ...
      if attributes.key?(:'google_place_type')
        self.google_place_type = attributes[:'google_place_type']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          foursquare_type == o.foursquare_type &&
          google_place_id == o.google_place_id &&
          google_place_type == o.google_place_type &&
    ...
    def hash
      [type, id, latitude, longitude, title, address, foursquare_id, foursquare_type, google_place_id, google_place_type, reply_markup, input_message_content, thumbnail_url, thumbnail_width, thumbnail_height].hash
    end
