...
module TelegramBotOpenapi
  ...
  class KeyboardButtonRequestUsers
    ...
    attr_accessor :user_is_bot

    # Optional. Pass True to request premium users, pass False to request non-premium users. If not specified, no additional restrictions are applied.
    attr_accessor :user_is_premium
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::KeyboardButtonRequestUsers` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::KeyboardButtonRequestUsers`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'user_is_bot')
        self.user_is_bot = attributes[:'user_is_bot']
      end

      if attributes.key?(:'user_is_premium')
        self.user_is_premium = attributes[:'user_is_premium']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_is_bot == o.user_is_bot &&
          user_is_premium == o.user_is_premium &&
    ...
    def hash
      [request_id, user_is_bot, user_is_premium, max_quantity, request_name, request_username, request_photo].hash
    end
