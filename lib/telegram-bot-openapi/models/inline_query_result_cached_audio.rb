  ...
  class InlineQueryResultCachedAudio
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultCachedAudio` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultCachedAudio`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'audio_file_id')
        self.audio_file_id = attributes[:'audio_file_id']
      else
        self.audio_file_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @audio_file_id.nil?
        invalid_properties.push('invalid value for "audio_file_id", audio_file_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @audio_file_id.nil?
      true
    end
    ...
    def hash
      [type, id, audio_file_id, caption, parse_mode, caption_entities, reply_markup, input_message_content].hash
    end
