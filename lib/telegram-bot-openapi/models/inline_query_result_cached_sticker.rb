  ...
  class InlineQueryResultCachedSticker
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultCachedSticker` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultCachedSticker`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sticker_file_id')
        self.sticker_file_id = attributes[:'sticker_file_id']
      else
        self.sticker_file_id = nil
      end
    ...
    def valid?
      ...
      return false if @sticker_file_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          id == o.id &&
          sticker_file_id == o.sticker_file_id &&
    ...
    def hash
      [type, id, sticker_file_id, reply_markup, input_message_content].hash
    end
