...
module TelegramBotOpenapi
  ...
  class InlineQueryResultCachedDocument
    ...
    attr_accessor :document_file_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultCachedDocument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultCachedDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'document_file_id')
        self.document_file_id = attributes[:'document_file_id']
      else
        self.document_file_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @document_file_id.nil?
        invalid_properties.push('invalid value for "document_file_id", document_file_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @document_file_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          title == o.title &&
          document_file_id == o.document_file_id &&
    ...
    def hash
      [type, id, title, document_file_id, description, caption, parse_mode, caption_entities, reply_markup, input_message_content].hash
    end
