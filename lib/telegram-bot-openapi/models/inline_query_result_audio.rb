  ...
  class InlineQueryResultAudio
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TelegramBotOpenapi::InlineQueryResultAudio` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TelegramBotOpenapi::InlineQueryResultAudio`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'audio_duration')
        self.audio_duration = attributes[:'audio_duration']
      end
    ...
    def list_invalid_properties
      ...
      if @audio_url.nil?
        invalid_properties.push('invalid value for "audio_url", audio_url cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          audio_duration == o.audio_duration &&
    ...
    def hash
      [type, id, audio_url, title, caption, parse_mode, caption_entities, performer, audio_duration, reply_markup, input_message_content].hash
    end
