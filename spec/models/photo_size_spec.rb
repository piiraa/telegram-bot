...
# Unit tests for TelegramBotOpenapi::PhotoSize
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::PhotoSize do
  let(:instance) { TelegramBotOpenapi::PhotoSize.new }

  describe 'test an instance of PhotoSize' do
    it 'should create an instance of PhotoSize' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::PhotoSize)
    end
  end
