...
# Unit tests for TelegramBotOpenapi::ForwardMessages200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::ForwardMessages200Response do
  let(:instance) { TelegramBotOpenapi::ForwardMessages200Response.new }
  ...
  describe 'test an instance of ForwardMessages200Response' do
    it 'should create an instance of ForwardMessages200Response' do
      ...
      #expect(instance).to be_instance_of(TelegramBotOpenapi::ForwardMessages200Response)
    end
  end
