...
# Unit tests for TelegramBotOpenapi::ForceReply
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::ForceReply do
  let(:instance) { TelegramBotOpenapi::ForceReply.new }

  describe 'test an instance of ForceReply' do
    it 'should create an instance of ForceReply' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::ForceReply)
    end
  end
