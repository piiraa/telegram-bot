...
# Unit tests for TelegramBotOpenapi::InlineQueryResultVideo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::InlineQueryResultVideo do
  let(:instance) { TelegramBotOpenapi::InlineQueryResultVideo.new }

  describe 'test an instance of InlineQueryResultVideo' do
    it 'should create an instance of InlineQueryResultVideo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::InlineQueryResultVideo)
    end
  end
