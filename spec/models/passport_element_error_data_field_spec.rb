...
# Unit tests for TelegramBotOpenapi::PassportElementErrorDataField
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::PassportElementErrorDataField do
  let(:instance) { TelegramBotOpenapi::PassportElementErrorDataField.new }
  ...
  describe 'test an instance of PassportElementErrorDataField' do
    it 'should create an instance of PassportElementErrorDataField' do
      ...
      #expect(instance).to be_instance_of(TelegramBotOpenapi::PassportElementErrorDataField)
    end
  end
