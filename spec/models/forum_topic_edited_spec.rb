...
# Unit tests for TelegramBotOpenapi::ForumTopicEdited
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::ForumTopicEdited do
  let(:instance) { TelegramBotOpenapi::ForumTopicEdited.new }

  describe 'test an instance of ForumTopicEdited' do
    it 'should create an instance of ForumTopicEdited' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::ForumTopicEdited)
    end
  end
