...
# Unit tests for TelegramBotOpenapi::PassportData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::PassportData do
  let(:instance) { TelegramBotOpenapi::PassportData.new }

  describe 'test an instance of PassportData' do
    it 'should create an instance of PassportData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::PassportData)
    end
  end
