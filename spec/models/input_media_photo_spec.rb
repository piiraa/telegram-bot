...
# Unit tests for TelegramBotOpenapi::InputMediaPhoto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::InputMediaPhoto do
  let(:instance) { TelegramBotOpenapi::InputMediaPhoto.new }

  describe 'test an instance of InputMediaPhoto' do
    it 'should create an instance of InputMediaPhoto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::InputMediaPhoto)
    end
  end
