...
# Unit tests for TelegramBotOpenapi::ForumTopic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::ForumTopic do
  let(:instance) { TelegramBotOpenapi::ForumTopic.new }

  describe 'test an instance of ForumTopic' do
    it 'should create an instance of ForumTopic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::ForumTopic)
    end
  end
