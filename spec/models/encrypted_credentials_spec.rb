...
# Unit tests for TelegramBotOpenapi::EncryptedCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::EncryptedCredentials do
  let(:instance) { TelegramBotOpenapi::EncryptedCredentials.new }

  describe 'test an instance of EncryptedCredentials' do
    it 'should create an instance of EncryptedCredentials' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::EncryptedCredentials)
    end
  end
