...
# Unit tests for TelegramBotOpenapi::OrderInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::OrderInfo do
  let(:instance) { TelegramBotOpenapi::OrderInfo.new }

  describe 'test an instance of OrderInfo' do
    it 'should create an instance of OrderInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::OrderInfo)
    end
  end
