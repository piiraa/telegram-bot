...
# Unit tests for TelegramBotOpenapi::Document
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::Document do
  let(:instance) { TelegramBotOpenapi::Document.new }

  describe 'test an instance of Document' do
    it 'should create an instance of Document' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::Document)
    end
  end
