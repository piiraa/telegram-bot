...
# Unit tests for TelegramBotOpenapi::InputMediaAnimation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::InputMediaAnimation do
  let(:instance) { TelegramBotOpenapi::InputMediaAnimation.new }

  describe 'test an instance of InputMediaAnimation' do
    it 'should create an instance of InputMediaAnimation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::InputMediaAnimation)
    end
  end
