...
# Unit tests for TelegramBotOpenapi::EditMessageText200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::EditMessageText200Response do
  let(:instance) { TelegramBotOpenapi::EditMessageText200Response.new }
  ...
  describe 'test an instance of EditMessageText200Response' do
    it 'should create an instance of EditMessageText200Response' do
      ...
      #expect(instance).to be_instance_of(TelegramBotOpenapi::EditMessageText200Response)
    end
  end
