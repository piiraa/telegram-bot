...
# Unit tests for TelegramBotOpenapi::VideoNote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::VideoNote do
  let(:instance) { TelegramBotOpenapi::VideoNote.new }

  describe 'test an instance of VideoNote' do
    it 'should create an instance of VideoNote' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::VideoNote)
    end
  end
