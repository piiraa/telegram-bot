...
# Unit tests for TelegramBotOpenapi::ExportChatInviteLink200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::ExportChatInviteLink200Response do
  let(:instance) { TelegramBotOpenapi::ExportChatInviteLink200Response.new }
  ...
  describe 'test an instance of ExportChatInviteLink200Response' do
    it 'should create an instance of ExportChatInviteLink200Response' do
      ...
      #expect(instance).to be_instance_of(TelegramBotOpenapi::ExportChatInviteLink200Response)
    end
  end
