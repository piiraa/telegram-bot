...
# Unit tests for TelegramBotOpenapi::Contact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::Contact do
  let(:instance) { TelegramBotOpenapi::Contact.new }

  describe 'test an instance of Contact' do
    it 'should create an instance of Contact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::Contact)
    end
  end
