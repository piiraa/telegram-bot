...
# Unit tests for TelegramBotOpenapi::Animation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::Animation do
  let(:instance) { TelegramBotOpenapi::Animation.new }

  describe 'test an instance of Animation' do
    it 'should create an instance of Animation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::Animation)
    end
  end
