...
# Unit tests for TelegramBotOpenapi::Story
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe TelegramBotOpenapi::Story do
  let(:instance) { TelegramBotOpenapi::Story.new }

  describe 'test an instance of Story' do
    it 'should create an instance of Story' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(TelegramBotOpenapi::Story)
    end
  end
